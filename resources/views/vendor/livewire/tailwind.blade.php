            ...
            <div class="flex justify-between flex-1 sm:hidden">
                <span>
                    @if ($paginator->onFirstPage())
                        <span class="relative inline-flex items-center px-3 py-1 text-sm font-medium text-gray-500 bg-white border border-gray-300 cursor-default leading-5 rounded   ">
                ...
                <span>
                    ...
                    @else
                        <span class="relative inline-flex items-center px-3 py-1 ml-3 text-sm font-medium text-gray-500 bg-white border border-gray-300 cursor-default leading-5 rounded">
                            {!! __('pagination.next') !!}
                        </span>
                    @endif
                </span>
...
{{--                <div>
                ...
                <div>
                    <span class="relative z-0 inline-flex rtl:flex-row-reverse rounded">
                        <span>
                            {{-- Previous Page Link --}}
                            @if ($paginator->onFirstPage())
                                <span aria-disabled="true" aria-label="{{ __('pagination.previous') }}">
                                    <span class="relative inline-flex items-center px-2 py-1 text-sm font-medium text-gray-500 bg-white border border-gray-300 cursor-default rounded" aria-hidden="true">

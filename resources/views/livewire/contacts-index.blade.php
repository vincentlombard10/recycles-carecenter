                    ...
                    <div class="grid grid-cols-[auto_8rem] gap-4">
                        <div class="grid md:grid-cols-[8rem_auto] gap-4">
                            ...
                            <div class="column-right grid grid-cols-[auto_16rem] gap-4">
                                ...
                                <div>
                                    <div class="text-xs">Création
                                        : {{ date('d/m/Y H:i', strtotime($contact->created_at)) }}</div>
                                    <div class="text-xs">Dernière modification
                                        : {{ date('d/m/Y H:i', strtotime($contact->updated_at)) }}</div>
                                </div>
                            </div>
                        </div>

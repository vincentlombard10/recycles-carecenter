...
return new class extends Migration {
    public function up(): void
    {
        Schema::create('tickets', function (Blueprint $table) {
            ...
            $table->integer('first_resolved_time_in_minutes')->nullable();
            $table->integer('first_resolved_time_in_minutes_within_business_hours')->nullable();
            ...
            $table->integer('requester_wait_time_in_minutes_wthin_business_hours')->nullable();

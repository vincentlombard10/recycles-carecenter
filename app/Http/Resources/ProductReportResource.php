...
class ProductReportResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'batteryKeyQty' => $this->battery_key_qty,
            'lockKey' => $this->lock_key,
            'lockKeyQty' => $this->lock_key_qty,
            'charger' => $this->charger,
            'chargerQty' => $this->charger_qty,
            'battery' => $this->battery,
            'batteryQty' => $this->battery_qty,
            'pedals' => $this->pedals,
            'pedalsQty' => $this->pedals_qty,
            'frontWheel' => $this->front_wheel,
            'frontWheelQty' => $this->front_wheel_qty,
            'rearWheel' => $this->rear_wheel,
            'rearWheelQty' => $this->rear_wheel_qty,
            'saddle' => $this->saddle,
            'saddleQty' => $this->saddle_qty,
            'seatpost' => $this->seatpost,
            'seatpostQty' => $this->seatpost_qty,
            'display' => $this->display,
            'displayQty' => $this->display_qty,
            'motor' => $this->motor,
            'motorQty' => $this->motor_qty,
